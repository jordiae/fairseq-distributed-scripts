#!/bin/bash
#SBATCH --job-name=roberta_base_en_test
#SBATCH -D /gpfs/projects/bsc88/BERTs/models/roberta_base_en_test
#SBATCH --output=roberta_base_en_test.out
#SBATCH --error=roberta_base_en_test.err
#SBATCH --nodes=2
#SBATCH --wait
...
fairseq_cmd() {
    ...
    # Fairseq parameters
    DATA_DIR=/gpfs/scratch/bsc88/bsc88251/DistributedBERTTest/data-bin/wikitext-103
